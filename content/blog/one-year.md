...
Ironically, [Nuxt SaaS Kit](https://nuxtsaaskit.com?ref=okikelabs), the one product that worked wasn’t even meant to be a product. It started as something internal, a boilerplate to save us setup time for future products. As engineers, we did not want to repeat the same setup over and over again.
But around that time, boilerplates were trending. Everyone was building them for React and Next, but no one for Nuxt. So we decided to launch it as a product to fill the gap.
...
**Burning out:** Multiple times. The guilt of only having a boilerplate. The shame of being busy without being productive. We were doing everything but not actually doing _something_.
...
If I’m being honest, year one wasn’t special. It was messy, inconsistent, and slower than I hoped. But it was real. At least I know what the issues are and how to fix them, whatever is in my control.
And maybe that’s what year one is supposed to be — a long test of whether you’ll still show up when it’s not exciting anymore.
